<x-guest-layout>
        <x-header />
               ...
               {{-- <div class="flex h-screen">
                   ...
                   <button data-drawer-target="default-sidebar" aria-controls="default-sidebar" type="button" class="hidden p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" onclick="document.getElementById('default-sidebar').classList.toggle('-translate-x-full');">
                       <span class="sr-only">Cerrar barra lateral</span>
                       <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                           <path fill-rule="evenodd" d="M6.293 14.293a1 1 0 0 1 0-1.414L10.586 10 6.293 5.707a1 1 0 1 1 1.414-1.414L12 8.586l4.293-4.293a1 1 0 0 1 1.414 1.414L13.414 10l4.293 4.293a1 1 0 0 1-1.414 1.414L12 11.414l-4.293 4.293a1 1 0 0 1-1.414 0z" clip-rule="evenodd"></path>
                       </svg>
                   </button>
                       ...
                       <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
                           <ul class="space-y-2 font-medium">
                               ...
                               <li>
                                   ...
                                   <span class="flex-1 ms-3 whitespace-nowrap">Buscar</span>
                                   </a>
                               </li>
                               <li>
                               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                               ...
                               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                                   ...
                                   <span class="flex-1 ms-3 whitespace-nowrap">Mis compras</span>               
                               </a>
                               </li>
                               <li>
                               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                               ...
                               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                   ...
                                   <span class="flex-1 ms-3 whitespace-nowrap">Ofertas</span>
                           ...
                           <li>
                               ...
                               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                   ...
                                   <span class="flex-1 ms-3 whitespace-nowrap">Tiendas oficiales</span>
                               </a>
                               </li>
                               <li>
                               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                   ...
                                   <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">NUEVO</span>
                               </a>
                               </li>
                           </ul>
                       </div>
                   ...
                   <main class="flex-1 p-6">
                       ...
                       <!-- Lista de contenido -->
                       <ul class="space-y-4">
                           <li class="bg-white shadow-md rounded-lg p-4 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
                           ...
                           <div class="flex items-center space-x-4">
                               ...
                               <p class="text-sm text-gray-600">Write, test, and deploy your code efficiently</p>
                               </div>
                           </div>
                           </li>
                           ...
                           <div class="flex items-center space-x-4">
                               ...
                               <p class="text-sm text-gray-600">Work together with your team in real-time</p>
                               </div>
                           </div>
                           </li>
                       </ul>
            ...
            <button data-drawer-target="sidebar" aria-controls="sidebar" type="button" class="hidden p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" onclick="document.getElementById('default-sidebar').classList.toggle('-translate-x-full');">
               ...
               <div class="fixed top-30 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0">                              
                
                <aside id="sidebar" class="top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                    <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">                       
                        <ul class="space-y-2 font-medium">
                            <li>
                                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <main class="flex-1 p-6">
                       ...
                       <ul class="space-y-4">
                           ...
                           <div class="flex items-center space-x-4">
                               ...
                               <div>
                               <h3 class="text-lg font-semibold dark:text-white text-gray-800">Tu informacion</h3>
                               <p class="text-sm dark:text-gray-300 text-gray-600">Nombre elegido y datos para identificarse</p>
                               </div>
                           </div>
                           </li>
                           ...
                           <div class="flex items-center space-x-4">
                               ...
                               <div>
                               <h3 class="text-lg font-semibold dark:text-white text-gray-800">Datos de cuenta</h3>
                               <p class="text-sm dark:text-gray-300 text-gray-600">Datos que representan a la cuenta</p>
                               </div>
                           ...
                           <div class="flex items-center space-x-4">
                               ...
                               <div>
                               <h3 class="text-lg font-semibold dark:text-white text-gray-800">Seguridad</h3>
                               <p class="text-sm dark:text-gray-300 text-gray-600">Write, test, and deploy your code efficiently</p>
                               </div>
                           </div>
                           </li>
                           ...
                           <div class="flex items-center space-x-4">
                               ...
                               <div>
                               <h3 class="text-lg font-semibold dark:text-white text-gray-800">Direcciones</h3>
                               <p class="text-sm dark:text-gray-300 text-gray-600">Direcciones guardadas en tu cuenta</p>
                               </div>
                           </div>
                           </li>
                       </ul>
